...
class BaseZincCompileIntegrationTest(object):
  ...
  def no_test_scala_compile_jar(self):
    jar_suffix = 'z.jar'
  ...
  def no_test_scala_empty_compile(self):
  ...
  def no_test_scala_shared_sources(self):
  ...
  def no_test_scala_failure(self):
  ...
  def no_test_scala_with_java_sources_compile(self):
  ...
  def no_test_scalac_plugin_compile(self):
  ...
  def no_test_analysis_portability(self):
  ...
  def test_zinc_fatal_warning(self):
    ...
    test_combination('defaultfatal', default_fatal_warnings=False, expect_success=False)
  ...
  def no_test_pool_created_for_fresh_compile_but_not_for_valid_compile(self):
